...
# 2. Supabase URL
echo [REDACTED_URL] | vercel env add NEXT_PUBLIC_SUPABASE_URL production
...
echo "[REDACTED_KEY]" | vercel env add SUPABASE_SERVICE_ROLE_KEY production
...
|----------|-------|--------|
| `GEMINI_API_KEY` | (redacted) | ✅ Encrypted |
